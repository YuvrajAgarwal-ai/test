...
public class MessagesAdater extends RecyclerView.Adapter<MessagesAdater.MessageViewHolder>
{
    private List<Messages> userMessagesList;
    private FirebaseAuth mAuth;
    private DatabaseReference usersDatabaseRef;

    public MessagesAdater (List<Messages> userMessagesList)
    {
    ...
    @Override
    public void onBindViewHolder(@NonNull MessagesAdater.MessageViewHolder holder, int position)
    {
